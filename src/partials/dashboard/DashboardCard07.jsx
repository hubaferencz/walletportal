  ...
  return (
    <div className="col-span-full xl:col-span-6 shadow-lg rounded-sm chart-box">
      <header className="px-5 py-4 ">
        <h2 className="font-semibold text-slate-800 text-lg">Assets</h2>
      </header>
      <div className="p-3">
        {/* Table */}
              ...
              <tr>
                <td className="p-2">
                  <div className="flex items-center">
                    ...
                    <div className="text-slate-800">Bitcoin</div>
                  </div>
                </td>
              ...
              <tr>
                <td className="p-2">
                  <div className="flex items-center">
                    ...
                    <div className="text-slate-800">Ethereum</div>
                  </div>
                </td>
                <td className="p-2">
                ...
                <td className="p-2">
                  <div className="text-center ">4.4%</div>
                </td>
              </tr>
              {/* Row */}
              <tr>
                <td className="p-2">
                  <div className="flex items-center">
                    ...
                    <div className="text-slate-800">Polygon</div>
                  </div>
                </td>
                <td className="p-2">
              ...
              <tr>
                <td className="p-2">
                  <div className="flex items-center">
                    ...
                    <div className="text-slate-800">Monero</div>
                  </div>
                </td>
                <td className="p-2">
              ...
              <tr>
                <td className="p-2">
                  <div className="flex items-center">
                    ...
                    <div className="text-slate-800">Cosmos</div>
                  </div>
                </td>
                <td className="p-2">
